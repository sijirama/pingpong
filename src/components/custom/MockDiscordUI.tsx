...
export default function MockDiscordUI({ children }: PropsWithChildren) {
    return (
        <div className='flex min-h-[800px] w-full max-w-[1200px] bg-discord-background text-white rounded-lg oveflow-hidden shadow-xl'>
            {/* server list */}
            <div className='hidden sm:flex w-[72px] bg-[#202225] py-3 flex-col items-center rounded-lg'>
                ...
                <div className='mt-auto size-12 bg-discord-background rounded-3xl flex items-center justify-center mb-3 hover:rounded-xl transition-all duration-200 hover:bg-[#3ba55c] group' >
            ...
            <div className='hidden md:flex w-60 bg-[#2f3136] flex-col '>
                ...
                <div className='flex-1 overflow-y-auto pt-4'>
                    ...
                    <div className='px-2 mb-4 '>
                        ...
                        <div className='flex items-center px-2 py-1.5 rounded bg-[#393c43] text-white cursor-pointer'>
                            ...
                            <Image src="/brand-asset-profile-picture.png"
                                alt='PingPong Avatar'
                                width={32}
                                height={32}
                ...
                <div className='p-2 bg-[#292b2f] flex items-center'>
                    ...
                    <div className='flex-1'>
                        ...
                        <p className='text-xs text-[#b9bbb3] flex items-center'>@your account</p>
                    </div>
            ...
            <div className='flex-1 flex flex-col'>
                {/*dm header*/}
                <div className='h-16  items-center px-4 border-b border-[#202225] bg-[#36393f] shadow-sm flex'>
                    ...
                    <div className='flex items-center'>
                        ...
                        <p className='font-semibold text-white'>PingPong</p>
                    </div>
                    <div className='ml-auto flex items-center space-x-4 text-[#b9bbb3] '>
                ...
                <div className='p-4 '>
                    <div className='flex items-center bg-[#40444b] rounded-lg p-1'>
                        ...
                        <input type='text' readOnly placeholder='Message @PingPong'
